...
lightrag-stats:
    ...
    @python -c "from slidex.core.lightrag_client import lightrag_client; import json; print(json.dumps(lightrag_client.get_stats(), indent=2))" || echo "Error loading LightRAG"
